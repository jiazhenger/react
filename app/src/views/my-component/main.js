		...
		return (
			<div className="full-screen">
				<header className="header">
					<h1 className="logo"><Link to="/my-component"><img src={logo} alt=""/></Link></h1>
				...
				<section className="container">
					<aside className="navigation oys" id="navigation">
						<ul>
							<li>
								<h3 className="js-tit"><span>test</span><i className="font-angle-right"></i></h3>
								<menu>
									<li><NavLink to="my-component/test" activeClassName="active">test</NavLink></li>
								</menu>
							</li>
						</ul>
					</aside>
